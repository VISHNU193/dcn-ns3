...
main(int argc, char* argv[])
{
   ...
   /* if (transportProt == "Tcp")
    ...
    NetDeviceContainer devices01,devices12,devices31;
    ...
    Ipv4InterfaceContainer interfaces1 = address.Assign(devices01);
    address.SetBase("10.1.2.0", "255.255.255.0");
    Ipv4InterfaceContainer interfaces2 = address.Assign(devices12);
    address.SetBase("10.1.3.0", "255.255.255.0");
    Ipv4InterfaceContainer interfaces3 = address.Assign(devices31);
    address.SetBase("10.1.4.0", "255.255.255.0");
    Ipv4InterfaceContainer interfaces4 = address.Assign(devices12);
    ...
    InetSocketAddress rmt(interfaces2.GetAddress(1), port);
    rmt.SetTos(0xb8);
    ...
    InetSocketAddress rmt1(interfaces4.GetAddress(1), port);
    rmt1.SetTos(0xb8);
    ...
    for( auto iter = stats.begin(); iter != stats.end();iter++){
    	std::cout << " TX "<< iter->second.txPackets<<std::endl;
    	std::cout << " RX "<< iter->second.rxPackets<<std::endl;
    	std::cout << " LX "<< iter->second.lostPackets<<std::endl;
    }
    Simulator::Destroy();
